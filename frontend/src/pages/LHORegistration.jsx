  ...
  <script>
    ...
    async function handleSubmitApplication() {
      ...
      try {
         ...
         */
        const response = await fetch('https://emmc-push-backend.onrender.com/api/lho/register', {
          method: 'POST',
          headers: {
        ...
        try {
          ...
          throw new Error(
            \`Backend returned a non-JSON response (HTTP \${response.status}). Please make sure the latest LHO routes are deployed on Render.\`
          );
        }
